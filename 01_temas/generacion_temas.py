...
NUM_TEMAS_TOTAL = 10  # Total de temas que queremos tener siempre disponibles
MODELO = "gpt-4"
TEMPERATURE = 0.7
MAX_TOKENS = 1000
...
- Data mesh, data fabric y arquitecturas descentralizadas
...
if __name__ == "__main__":
    ...
    if cantidad_faltante <= 0:
        logger.info(f"No se requieren nuevos temas. Ya hay {len(temas_actuales)} temas disponibles.")
    else:
